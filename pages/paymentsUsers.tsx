// 🔁 payment.tsx dla lekarzy i dietetyków (tabela users zamiast patients)
// Dwa abonamenty: 30 dni (390 zł), 365 dni (3800 zł) – bez limitu generowania diet
...
export default function PaymentsUsersPage() {
