...
- "time" (e.g. "07:30")
- "menu" (short meal description)
- "kcal" (energy in kcal)
- "glycemicIndex" (numerical estimate; required)
- "ingredients" (array of { "product": string, "weight": number })

Return JSON only – no markdown, no code blocks, no explanations or comments.
