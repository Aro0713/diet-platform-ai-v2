const fallbackDiets: Record<string, any[]> = {
    ...
    de: [
        { name: "Frühstück", ingredients: [{ product: "Haferflocken", weight: 50 }, { product: "Milch", weight: 200 }], calories: 300, glycemicIndex: 45 },
        { name: "Zweites Frühstück", ingredients: [{ product: "Naturjoghurt", weight: 150 }, { product: "Banane", weight: 120 }], calories: 250, glycemicIndex: 55 },
        { name: "Mittagessen", ingredients: [{ product: "Hähnchen", weight: 150 }, { product: "Vollkornreis", weight: 100 }, { product: "Brokkoli", weight: 80 }], calories: 550, glycemicIndex: 50 },
        { name: "Nachmittagsimbiss", ingredients: [{ product: "Mandeln", weight: 30 }, { product: "Apfel", weight: 150 }], calories: 280, glycemicIndex: 35 },
        { name: "Abendessen", ingredients: [{ product: "Eier", weight: 100 }, { product: "Roggenbrot", weight: 60 }, { product: "Tomate", weight: 80 }], calories: 400, glycemicIndex: 40 }
      ],
      hi: [
        { name: "नाश्ता", ingredients: [{ product: "ओट्स", weight: 50 }, { product: "दूध", weight: 200 }], calories: 300, glycemicIndex: 45 },
        { name: "दूसरा नाश्ता", ingredients: [{ product: "सादा दही", weight: 150 }, { product: "केला", weight: 120 }], calories: 250, glycemicIndex: 55 },
        { name: "दोपहर का भोजन", ingredients: [{ product: "चिकन", weight: 150 }, { product: "ब्राउन राइस", weight: 100 }, { product: "ब्रोकोली", weight: 80 }], calories: 550, glycemicIndex: 50 },
        { name: "नाश्ता", ingredients: [{ product: "बादाम", weight: 30 }, { product: "सेब", weight: 150 }], calories: 280, glycemicIndex: 35 },
        { name: "रात का खाना", ingredients: [{ product: "अंडे", weight: 100 }, { product: "राई ब्रेड", weight: 60 }, { product: "टमाटर", weight: 80 }], calories: 400, glycemicIndex: 40 }
      ],
      he: [
        { name: "ארוחת בוקר", ingredients: [{ product: "שיבולת שועל", weight: 50 }, { product: "חלב", weight: 200 }], calories: 300, glycemicIndex: 45 },
        { name: "ארוחת ביניים", ingredients: [{ product: "יוגורט טבעי", weight: 150 }, { product: "בננה", weight: 120 }], calories: 250, glycemicIndex: 55 },
        { name: "ארוחת צהריים", ingredients: [{ product: "עוף", weight: 150 }, { product: "אורז מלא", weight: 100 }, { product: "ברוקולי", weight: 80 }], calories: 550, glycemicIndex: 50 },
        { name: "חטיף", ingredients: [{ product: "שקדים", weight: 30 }, { product: "תפוח", weight: 150 }], calories: 280, glycemicIndex: 35 },
        { name: "ארוחת ערב", ingredients: [{ product: "ביצים", weight: 100 }, { product: "לחם שיפון", weight: 60 }, { product: "עגבנייה", weight: 80 }], calories: 400, glycemicIndex: 40 }
      ],
      zh: [
        { name: "早餐", ingredients: [{ product: "燕麦", weight: 50 }, { product: "牛奶", weight: 200 }], calories: 300, glycemicIndex: 45 },
        { name: "加餐", ingredients: [{ product: "原味酸奶", weight: 150 }, { product: "香蕉", weight: 120 }], calories: 250, glycemicIndex: 55 },
        { name: "午餐", ingredients: [{ product: "鸡肉", weight: 150 }, { product: "糙米", weight: 100 }, { product: "西兰花", weight: 80 }], calories: 550, glycemicIndex: 50 },
        { name: "下午茶", ingredients: [{ product: "杏仁", weight: 30 }, { product: "苹果", weight: 150 }], calories: 280, glycemicIndex: 35 },
        { name: "晚餐", ingredients: [{ product: "鸡蛋", weight: 100 }, { product: "黑麦面包", weight: 60 }, { product: "番茄", weight: 80 }], calories: 400, glycemicIndex: 40 }
      ],
