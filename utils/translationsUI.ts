...
"hero.claimFootnote": {
  pl: "Wg naszej najlepszej wiedzy (IX 2025) DCP jest pierwszą platformą ukierunkowaną na klinicystów, która łączy: analizę AI badań → analizę AI stylu życia i preferencji → agentowe (AI) generowanie planu diety → kliniczną walidację makro/mikro/witamin → przepisy/PDF → osobistego asystenta AI (LOOK) — i to wszystko w 11 językach.",
  en: "To the best of our knowledge (Sep 2025), DCP is the first clinician-focused platform that combines: AI analysis of lab results → AI analysis of lifestyle and preferences → agent-based (AI) diet plan generation → clinical validation of macro/micro/vitamins → recipes/PDF → a personal AI assistant (LOOK) — all in 11 languages.",
  es: "Según nuestro mejor entender (sep. de 2025), DCP es la primera plataforma orientada a clínicos que combina: análisis con IA de resultados de laboratorio → análisis con IA del estilo de vida y las preferencias → generación de planes de dieta basada en agentes (IA) → validación clínica de macro/micro/vitaminas → recetas/PDF → un asistente personal de IA (LOOK), todo en 11 idiomas.",
  fr: "À notre meilleure connaissance (sept. 2025), DCP est la première plateforme orientée cliniciens qui combine : analyse par IA des résultats de laboratoire → analyse par IA du mode de vie et des préférences → génération de plans alimentaires par agents (IA) → validation clinique des macro/micro/vitamines → recettes/PDF → un assistant personnel d’IA (LOOK) — le tout en 11 langues.",
  de: "Nach unserem besten Wissen (Sept. 2025) ist DCP die erste klinikerorientierte Plattform, die Folgendes vereint: KI-Analyse von Laborergebnissen → KI-Analyse von Lebensstil und Präferenzen → agentenbasiertes (KI) Erstellen von Ernährungsplänen → klinische Validierung von Makro/Mikro/Vitaminen → Rezepte/PDF → ein persönlicher KI-Assistent (LOOK) — alles in 11 Sprachen.",
  ua: "За нашими найкращими знаннями (вересень 2025 р.) DCP — перша платформа, орієнтована на клініцистів, яка поєднує: AI-аналіз лабораторних результатів → AI-аналіз способу життя та вподобань → агентне (AI) формування плану харчування → клінічну валідацію макро/мікро/вітамінів → рецепти/PDF → персонального AI-асистента (LOOK) — усе 11 мовами.",
  ru: "По нашим лучшим сведениям (сентябрь 2025 г.) DCP — первая платформа, ориентированная на клиницистов, которая объединяет: ИИ-анализ лабораторных результатов → ИИ-анализ образа жизни и предпочтений → агентную (ИИ) генерацию плана питания → клиническую валидацию макро/микро/витаминов → рецепты/PDF → персонального ИИ-ассистента (LOOK) — всё на 11 языках.",
  zh: "据我们所知（2025年9月），DCP 是首个面向临床人员的平台，集成：实验室结果的 AI 分析 → 生活方式与偏好的 AI 分析 → 基于智能体的（AI）饮食计划生成 → 宏量/微量/维生素的临床验证 → 食谱/PDF → 个人 AI 助手（LOOK）——并支持 11 种语言。",
  ar: "وفقًا لأفضل معلوماتنا (أيلول/سبتمبر 2025)، تعد DCP أول منصة موجّهة للأطباء تجمع بين: تحليل نتائج المختبر بالذكاء الاصطناعي → تحليل نمط الحياة والتفضيلات بالذكاء الاصطناعي → توليد خطة غذائية قائمة على الوكلاء (AI) → تحقّق سريري من المغذيات الكبرى/الصغرى/الفيتامينات → وصفات/PDF → مساعد شخصي بالذكاء الاصطناعي (LOOK) — وكل ذلك بـ 11 لغة.",
  hi: "हमारी सर्वोत्तम जानकारी (सितंबर 2025) के अनुसार, DCP पहला क्लिनिशियन-केंद्रित प्लेटफ़ॉर्म है जो जोड़ता है: प्रयोगशाला परिणामों का AI विश्लेषण → जीवनशैली और पसंद का AI विश्लेषण → एजेंट-आधारित (AI) डाइट-प्लान जनरेशन → मैक्रो/माइक्रो/विटामिन का क्लिनिकल वैलिडेशन → रेसिपी/PDF → व्यक्तिगत AI असिस्टेंट (LOOK) — यह सब 11 भाषाओं में।",
  he: "למיטב ידיעתנו (ספט׳ 2025), DCP היא הפלטפורמה הראשונה המכוונת לקלינאים שמשלבת: ניתוח תוצאות מעבדה ב-AI → ניתוח אורח חיים והעדפות ב-AI → יצירת תכנית תזונה מבוססת-סוכנים (AI) → ולידציה קלינית של מאקרו/מיקרו/ויטמינים → מתכונים/PDF → עוזר אישי מבוסס AI (LOOK) — הכול ב-11 שפות."
},
